...
public class PropertyDependencyInjection {
    public static void main(String agrs[]){

        // get application context
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("dependencyinjection/springvalueinjection");
